        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          <div className="space-y-4">
            ...
            <div className="flex space-x-4">
              <a href="https://www.linkedin.com/in/raghvendra1853/" className="text-gray-400 hover:text-cyan-400 transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#testimonials" className="text-gray-400 hover:text-cyan-400 transition-colors">About</a></li>
              <li><a href="#features" className="text-gray-400 hover:text-cyan-400 transition-colors">Features</a></li>
              <li><a href="#wizard" className="text-gray-400 hover:text-cyan-400 transition-colors">Tech Stack</a></li>
          ...
          <div>
            ...
            <p className="text-gray-400 mb-4">Connect With me for more Updates.</p>
            <form className="space-y-4">
              
              <a href="https://www.linkedin.com/in/raghvendra1853/" className="w-full mt-4 px-4 py-2 bg-gradient-to-r from-cyan-400 to-purple-600 text-white rounded-lg hover:opacity-90 transition-opacity">Conect</a>
            </form>
          </div>
        </div>
        {/* Bottom Bar */}
